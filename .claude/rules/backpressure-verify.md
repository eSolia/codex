...
The `verify` script should chain: oxlint (fast pass) → eslint (Svelte + custom rules) → svelte-check (types) → vitest (unit tests). See `docs/shared/guides/LINTING_STRATEGY.md` for the full setup.
