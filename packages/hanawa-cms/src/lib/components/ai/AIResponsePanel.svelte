    ...
    >
      ...
      <div class="flex items-center justify-between p-4 border-b border-gray-200">
        <div class="flex items-center gap-2">
          <svg class="w-5 h-5 text-esolia-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
          ...
          <h2 id="ai-response-title" class="text-lg font-semibold text-gray-900">
            AI Suggestion
          </h2>
        </div>
        ...
        {:else}
          {#if originalText && showDiff}
            <div class="mb-4">
              ...
              <div class="p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-gray-700 line-through">
                {originalText}
              </div>
            </div>
          {/if}
